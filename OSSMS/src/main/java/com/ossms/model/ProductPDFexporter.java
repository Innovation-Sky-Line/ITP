...
public class ProductPDFexporter {
	...
	public ProductPDFexporter(List<ProductList> productLists) {
		super();
...
//		table.addCell(cell);
	...
	private void writeTableData(PdfPTable table) {
		...
		for (ProductList pList : productLists) {
			...
			float fprice = pList.getProductModel().getPrice()
					- pList.getProductModel().getPrice() * pList.getProductModel().getDiscount() / 100;
...
//			table.addCell(String.valueOf(pList.getCategoryModel().getIdCategory()));
	...
	public void export(HttpServletResponse response) throws DocumentException, IOException {
		...
		Paragraph Topic2 = new Paragraph("Insufficient Product Report", font2);
		...
		Paragraph Topic3 = new Paragraph(
				"T.P : +94 68-222 22 54/ +94 76 324 45 66 | FAX : 87686756778 | Email : athukoralasm@gmail.com ",
				font3);
		...
		Paragraph title = new Paragraph("List of Insufficient Products.", font);
