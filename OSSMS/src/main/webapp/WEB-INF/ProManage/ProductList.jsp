...
<body>
	...
	<div class="sideBox">
		...
		<a href="/padmin/proManage"><button class="listBtn">Add
				New Products</button></a>
	</div>
	<br>
	<div class="msg" style="margin: auto; color: green; width: 30%;">
		<h4>${suc}</h4>
	</div>
			...
			<tbody>
				<c:forEach items="${productList }" var="p">
					<tr>
						...
						<td><img
							src="../../resources/Product-Images/${p.productModel.productImage }"
						...
						<td><spring:url
								value="/padmin/updateProduct/${p.productModel.idProduct }"
								var="updateURL" /> <a class="btn btn-primary"
							href="${updateURL }" role="button">Update</a></td>
						<td><spring:url
								value="/padmin/deleteProduct/${p.productModel.idProduct }"
