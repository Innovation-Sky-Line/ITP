                ...
                <div class="card-body table-responsive">
                  <table class="table" >
	                  ...
	                  <tr>
                        ...
                        <td>
                        	<table><tr><td>
					        	...
					        	<button type="submit" style="border:none; background-color:white;"><i class="material-icons">remove</i></button>
					        	</form:form> </td>
					        	<td>${cart.qty }</td> 
					        	<td><form:form action="/incrementCart" method="POST">
					        	<input type="text" name="orderId" value="${cart.orderId }" hidden/>
					        	<input type="text" name="prodId" value="${cart.prodId }" hidden/>
					        	<button type="submit" style="border:none; background-color:white;"><i class="material-icons">add</i></button>
					        	</form:form></td>
	        				</tr></table>
                        </td>
                        ...
                        <form:form action="/deleteCartItem" method="POST">
				        	<input type="text" name="orderId" value="${cart.orderId }" hidden/>
					        <input type="text" name="prodId" value="${cart.prodId }" hidden/>
                       		<td><button type="submit" style="border:none; background-color:white;"><i class="material-icons">delete</i></button></td>
	       				</form:form>
                      </tr>
                    </c:forEach>
                    <form:form action="/userpay" method="POST">
			          ...
			          <tr>
			          	<td id="btn-row" colspan="4"><button type="submit" class="btn btn-primary pull-right" 
			          			style="background-color:#5cb85c; font-size:15px;">Checkout</button></td>
			          </tr>
			          </form:form>
                    </tbody>
                  </table>
