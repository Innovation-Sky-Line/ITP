...
<body>
	...
	<section class="featured spad">
		<div class="container">
				...
				<div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
					<div class="featured__item">
						<div class="featured__item__pic set-bg"
							data-setbg="../../resources/Product-Images/${p.productImage }">
							<ul class="featured__item__pic__hover">
								<form:form action="/addToCart" method="POST">
									<input type="text" name="prodId" value="${p.idProduct }" hidden />
						...
						<div class="featured__item__text">
							...
							<c:set var="dis" value="${p.discount }"></c:set>
			...
			<c:set var="fail" value="${searchError }"></c:set>
